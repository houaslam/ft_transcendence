...
# from .elements.main import *
# from .elements.ball import *
...
def home_view(request):
	return render(request, 'game/index.html', context=animation());
	# render(request, 'index.html', context=allCoordinate);
	# animation(request)
# def api_return(request):
#     return 'elements/'
